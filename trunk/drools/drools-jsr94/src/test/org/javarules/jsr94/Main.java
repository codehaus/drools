...
public class Main
{
	public static void main(String[] args)
		throws Exception
	{
		String DROOLS_RULE_SERVICE_PROVIDER_CLASS = "org.drools.jsr94.rules.RuleServiceProviderImpl";
		String DROOLS_RULE_SERVICE_PROVIDER = "http://drools.org/";
        RuleServiceProviderManager.registerRuleServiceProvider(DROOLS_RULE_SERVICE_PROVIDER, org.drools.jsr94.rules.RuleServiceProviderImpl.class);

        Class.forName( DROOLS_RULE_SERVICE_PROVIDER_CLASS );
		runRuleset( DROOLS_RULE_SERVICE_PROVIDER, "testagent.drl", "Gecko" );
	}

	public static void runRuleset( String ruleServiceProvider, String fileName, String userAgent )
		throws Exception
	{
		...
		log(
			"Called executeRules on Stateless Rule Session: "
		...
		StatefulRuleSession statefulRuleSession =
			(StatefulRuleSession) ruleRuntime.createRuleSession(
				uri,
				new HashMap(),
		...
		log(
			"Called addObject on Stateful Rule Session: "
				+ statefulRuleSession);
