 ...
 * without using one of the many Semantic Modules. It is an ideal examples to learn
 * what is happening under the hood. It is accompanied by HelloWorldBuilder which
...
public class HelloWorld
{
    public static void main(String[] args) throws Exception
    {
         ...
         */
        final Declaration helloDeclaration = new Declaration(StringType, "hello");
        helloRule.addParameterDeclaration(helloDeclaration);

        /*
         * Build the declaration and specify it as a parameter of the goodbye Rule
         */
        final Declaration goodbyeDeclaration = new Declaration(StringType, "goodbye");
