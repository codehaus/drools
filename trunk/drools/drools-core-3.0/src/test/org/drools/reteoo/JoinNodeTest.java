...
public class JoinNodeTest extends DroolsTestCase
{
     ...
     * joins always succeed. This tests joins with BooleanExpressionConstraint.
     * We only use one constraint, as Constraints are tested more thorougly else
     * where, likewise for this reason we use a very simple constraint.
     * @throws Exception 
     * 
     */
    ...
    {        
        ...
        /* now check that constraint blocks these assertions
        /* assert tuple */
        FactHandleImpl f2 = new FactHandleImpl( 2 );
        workingMemory.putObject( f1,
                                 "string22" );
