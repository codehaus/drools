...
public class WorkingMemoryEventListenerBeanPostProcessorTest extends TestCase {
    ...
    public void testRegisterListeners() throws Exception {
        ConfigurableApplicationContext context = new ClassPathXmlApplicationContext("org/drools/spring/event/workingmemory-beanpostprocessor.appctx.xml");
