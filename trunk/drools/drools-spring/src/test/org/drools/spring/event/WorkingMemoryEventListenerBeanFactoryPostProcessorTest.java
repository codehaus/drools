...
public class WorkingMemoryEventListenerBeanFactoryPostProcessorTest extends TestCase {
    ...
    public void testRegisterListeners() throws Exception {
        ConfigurableApplicationContext context = new ClassPathXmlApplicationContext("org/drools/spring/event/workingmemory-beanfactorypostprocessor.appctx.xml");
