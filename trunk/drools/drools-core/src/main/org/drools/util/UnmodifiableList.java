...
import org.drools.util.Unmodifiable;
import org.drools.util.UnmodifiableIterator;
import org.drools.util.UnmodifiableListIterator;
    ...
    Unmodifiable
{
    ...
    public List subList(int fromIndex,
                        int toIndex)
    {
        List sub = getList( ).subList( fromIndex,
                                       toIndex );
