 ...
 * decorated <code>Collection</code>. This class is used as a framework on
 * which to build to extensions such as synchronized and unmodifiable behaviour.
 * The main advantage of decoration is that one decorator can wrap any
