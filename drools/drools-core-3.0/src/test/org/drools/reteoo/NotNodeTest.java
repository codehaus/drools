...
public class NotNodeTest extends DroolsTestCase
{
    ...
    {        
        ...
        /* assert object. While this object is correct there are 
         * incorrect tuples on the left side which will cause
         * no matches and those left tuples will propagate */
        ...
        /* assert object. While this one is incorrect
         * Two tuples already have matches so cannot propagate */
    ...
    public void testRetractPropagations() throws FactException
    {
        ...
        /* retracting the object should mean no matches for the left tuple.
         * So check left tuple propagated as assert */        
        ...
        /* retract the object, so we can later check a tuple retract with
        ...
        /* Make sure the propagated keys where not combined with the right
         * input object/handle */
