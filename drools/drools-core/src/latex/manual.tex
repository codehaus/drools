...
\newcommand{\tagContent}[1]{
        \\
        \hline
        \multicolumn{3}{l}{\textbf{\textsf{Content}}} \\
        \hline
  		\multicolumn{3}{l}{#1\hfill} \\
        \hline 
}
    ...
    \clearpage\thispagestyle{empty}
{
    ...
    {\noindent\Huge\partname\ \Roman{part}}
...
\renewcommand{\part}{\secdef\partLayout\partLayout}
...
\part{Drools---How and why}
\chapter {50,000ft view}
