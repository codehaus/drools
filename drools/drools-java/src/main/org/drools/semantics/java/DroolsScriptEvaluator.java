...
public class DroolsScriptEvaluator extends EvaluatorBase
{
    ...
    public DroolsScriptEvaluator(
        ...
        while (it.hasNext())
        {
	           ...
	           compilationUnit.addSingleTypeImport(loc, (String[]) list.toArray(new String[list.size()]));
        }
        ...
        try
        {
            c = this.compileAndLoad(compilationUnit, "DroolsConsequence");
        }
    ...
    private void addAppData(Scanner scanner, Java.Block block, Map appData, Set imports) //Declaration[] declarations)
    {
      ...
      while (it.hasNext())
      {
          ...
          Java.VariableDeclarator[]  variables = new Java.VariableDeclarator[] {       // variableDeclarators
                  new Java.VariableDeclarator(
                      ...
                      key,           // name
                      0,             // brackets
                      new Java.Cast( // optionalInitializer
                          loc,                                  // location
                          this.classToType(loc, object.getClass()), // targetType
                          new Java.MethodInvocation(            // value
                              loc,                    // location
          ...
          block.addStatement(new Java.LocalVariableDeclarationStatement(
              loc,                                  // location
              block,                                // declaringBock
              Mod.FINAL,                            // modifiers
              this.classToType(loc, object.getClass()), // type
              variables
          ));
      }
    }
        ...
        for ( int i = 0 ; i < declarations.length ; i++ ) {
          ...
          Java.VariableDeclarator[]  variables =  new Java.VariableDeclarator[] {       // variableDeclarators
                  new Java.VariableDeclarator(
                      ...
                      new Java.Cast( // optionalInitializer
                          loc,                                  // location
                          this.classToType(loc, clazz), // targetType
                          new Java.MethodInvocation(            // value
                              loc,                    // location
                              (Java.Scope) block,     // enclosingScope
                              new Java.AmbiguousName( // optionalTarget
                              ...
                              "get",                  // methodName
                              new Java.Rvalue[] {
                                new Java.ArrayAccessExpression(loc, new Java.AmbiguousName(loc, (Java.Scope) block, new String[] { "decls" }), new Java.ConstantValue(loc, PrimitiveWrapper.wrap(i) ))
                              }
                          )
                      )
                  )
          ...
          block.addStatement(new Java.LocalVariableDeclarationStatement(
              ...
              block,                                // declaringBock
              Mod.FINAL,                            // modifiers
              this.classToType(loc, clazz),         // type
              variables
          ));
      }
    }
