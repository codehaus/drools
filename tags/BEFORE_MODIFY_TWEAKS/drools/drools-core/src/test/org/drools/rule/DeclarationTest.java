...
public class DeclarationTest extends TestCase
{
    ...
    public void testConstruct_Complete()
    {
        ...
        Declaration decl = new Declaration( type, "cheese" );

        assertSame( type, decl.getObjectType( ) );

        assertEquals( "cheese", decl.getIdentifier( ) );
    }
    ...
    {
        Declaration decl1 = new Declaration(
        ...
        Declaration decl3 = new Declaration(
                                             new MockObjectType( Object.class ),
                                             "cheese" );
